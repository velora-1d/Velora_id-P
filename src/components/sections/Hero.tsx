    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-linear-to-br from-gray-900/90 via-gray-900/80 to-blue-500/50" />
      </div>
      ...
      {/* Floating Elements */}
      <div className="absolute top-1/4 left-10 w-72 h-72 bg-blue-500/30 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white mb-6 sm:mb-8 leading-tight tracking-tight">
            {t('title')}
            <br />
            <span className="bg-linear-to-r from-blue-500 via-blue-400 to-purple-400 bg-clip-text text-transparent">
              {t('titleHighlight')}
            </span>
          </h1>
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-sm sm:max-w-lg mx-auto">
            <div className="text-center">
              ...
              <div className="text-gray-400 text-xs sm:text-sm">{t('statsProjects')}</div>
            </div>
            <div className="text-center border-x border-white/10">
              <div className="text-2xl sm:text-4xl font-extrabold text-white mb-1">98%</div>
              <div className="text-gray-400 text-xs sm:text-sm">{t('statsClients')}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-4xl font-extrabold text-white mb-1">24/7</div>
              <div className="text-gray-400 text-xs sm:text-sm">{t('statsSupport')}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10">
        <div className="w-6 h-10 border-2 border-white/30 rounded-full flex items-start justify-center p-2">
          <div className="w-1 h-3 bg-white rounded-full animate-scroll-hint" />
        </div>
      </div>
    </section>
  );
